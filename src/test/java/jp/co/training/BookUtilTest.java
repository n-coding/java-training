...
import jp.co.training.book.BookValidater;
...
class BookUtilTest {
    ...
    class CheckLengthTest {
        ...
        void maxOverOK() {
            Optional<String> result = BookValidater.checkLength("あいう", 1, 3);
        ...
        void minUnderOK() {
            Optional<String> result = BookValidater.checkLength("あ", 1, 3);
            assertFalse(result.isPresent());
        }
        ...
        void maxOverNG() {
            Optional<String> result = BookValidater.checkLength("あいうえ", 1, 3);
        ...
        void minUnderNG() {
            Optional<String> result = BookValidater.checkLength("", 1, 3);
        ...
        void nullCheckNG() {
            Optional<String> result = BookValidater.checkLength(null, 1, 3);
    ...
    class checkDatePatternTest {
        ...
        void datePatternOK() {
            Optional<String> result = BookValidater.checkDatePattern("20180815", DATE_PATTERN);
            assertFalse(result.isPresent());
        }
        ...
        void datePatternNG() {
            Optional<String> result = BookValidater.checkDatePattern("20181815", DATE_PATTERN);
